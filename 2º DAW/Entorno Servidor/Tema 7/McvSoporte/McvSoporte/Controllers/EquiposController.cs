...
namespace McvSoporte.Controllers
{
    public class EquiposController : Controller
    {
        ...
        public EquiposController(McvSoporteContexto context)
        {
            _context = context;
        }
        ...
        {
            var mcvSoporteContexto = _context.Equipos.Include(e => e.Localizacion);
            return View(await mcvSoporteContexto.ToListAsync());
        }
