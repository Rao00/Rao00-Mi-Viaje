...
namespace Ejercicio17
{
    public partial class Form1 : Form
    {
        ...
        /// </summary>
        /// <param name="op">Valor de la operacion</param>
        string SeleccionarBoton(float op)
        {
            bSum.BackColor = System.Drawing.SystemColors.ControlLightLight;
            bSum.ForeColor = System.Drawing.SystemColors.ControlText;
            bRes.BackColor = System.Drawing.SystemColors.ControlLightLight;
            bRes.ForeColor = System.Drawing.SystemColors.ControlText;
            bMul.BackColor = System.Drawing.SystemColors.ControlLightLight;
            bMul.ForeColor = System.Drawing.SystemColors.ControlText;
            bDiv.BackColor = System.Drawing.SystemColors.ControlLightLight;
        ...
        {
            bool numFind = false;
            int WhereRead = int.Parse(txtSaveArray.Text);
            string salida = null;
        ...
        private void b1and2_Click(object sender, EventArgs e)
        {
            ...
            fila1 = SeleccionarArray(vglobal, int.Parse(txtFila1.Text));
            fila2 = SeleccionarArray(vglobal, int.Parse(txtFila2.Text));
            switch (action)
            {
